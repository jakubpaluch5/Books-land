...
<body>
  ...
  <div class="row">
  <div class="row filter_data" style="display: inline-block;
	float: right;
	width: 65vw;
	height: 100vh;
...
if(isset($_POST["action"]))
{
 ...
 if($total_row > 0)
 {
  ...
  {
   $output .= '
  <div class="card" style="width: 12vw; display:inline-block;">
  <img class="card-img-top" style="height: 20vw;" src="'.$bookfol.$row['photo'].'" alt="Card image cap">
  <div class="card-body" style="height: 6vw;">
   
  <a href="#" class="read-more btn btn-info container-fluid">Czytaj więcej!</a>
  </div>
   </div>
